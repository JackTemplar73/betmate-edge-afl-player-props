...
<body>
  <header>
    ...
    <p class="meta">Generated {datetime.now().strftime("%Y-%m-%d %H:%M")} from Model data + Odds API. Scope: current scored AFL player-prop card. Marks were unavailable through Odds API.</p>
  </header>
  <main>
    <section class="cards">
    ...
    <p>The chain means: does Model data like it, does probability agree, is the price wrong, and is confidence high?</p>
    {''.join(commentary)}
  </main>
</body>
</html>
